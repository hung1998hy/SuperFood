...
<?php $__env->startSection('title'); ?><?php echo e('User Profile'); ?><?php $__env->stopSection(); ?>
                        ...
                        <div class="col-md-4">
                            <div class="profile__left">
                                <div class="profile-name">
                                    ...
                                    <?php endif; ?>" alt="" width="150" height="150">
                                ...
                                <a href="/superFood/admin/userProfile/passEdit/<?php echo e($user->id); ?>" id="resetBtn" class="btn btn-light" style="width: 100%;display: flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <div class="col-md-8">
                            <div class="profile__right">
                                <div class="profile__info active">
                                    ...
                                    <form action="/superFood/admin/userProfile/update/<?php echo e($user->id); ?>" method="POST" enctype="multipart/form-data">
                                        <div class="avatar form-group">
                                            <p>Avatar</p>
                                            <div class="avatar_img" style="width: 60%">
                                                <img id="profileInfo_avatar" src="<?php if($user->images): ?>
                                                        /<?php echo e($_ENV['APP_NAME']); ?>/uploads/<?php echo e($user->images); ?>

                                                <?php else: ?>
                                                        /<?php echo e($_ENV['APP_NAME'].'/backend/assets/images/userImages/defaultImage.png'); ?>

                                                <?php endif; ?>" alt="" width="120" height="120">
                                                <label class="avatarLabel" for="avatar"><i class="fas fa-pen"></i>
                                                    <input style="display: none" type="file" id="avatar" name="fileToUpload">
                                                </label>
                                                <a href="/superFood/admin/userProfile/delete/<?php echo e($user->id); ?>" style="border: none; background: transparent" class="avatarDelete"><i class="fas fa-times"></i></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="email form-group">
                                            ...
                                            <div class="emailInput" style="display: flex;width: 60%">
                                                ...
                                                <input style="width: 100%" class="form-control" type="text"
                                                       name="profileEmail"
                                                       id="profileEmail" value="<?php echo e($user->email); ?>">
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SuperFood\resources\views/admin/userProfile/edit.blade.php ENDPATH**/ ?>